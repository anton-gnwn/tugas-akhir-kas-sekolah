    ...
    <body>
        <div id="wrap">
            <div id="header">
                ...
                <h1><a><b>MTS NURUL YAQIIN</b></a></h1>
            ...
            <div class="menu">
                ...
                <li class="item" id="transaksi">
                    ...
                    <div class="smenu">
                        <a href="beranda.jsp?hal=pembayaran">Pembayaran</a>
                        <a href="beranda.jsp?hal=input_biaya_operasional">Biaya Operasional</a>
                        
                    </div>
                </li>
                 
                <li class="item" id="jurnal">
                ...
                <li class="item" id="laporan">
                    ...
                    <div class="smenu">
                        <a href="beranda2.jsp?hal=laporan_harian">Penerimaan Kas</a>
                        <a href="beranda2.jsp?hal=laporan_bo">Biaya Operasional</a>
                        <a href="beranda2.jsp?hal=laporan_jurnal">Jurnal</a>
                    </div>
                </li>
                <li class="item" id="pengaturan">
                    ...
                    <div class="smenu">
                        <a href="beranda2.jsp?hal=edit_profil&id_user=<%=session.getAttribute("id_user") %>">Edit Profil</a>
