        ...
        <div id="wrap">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="beranda1.jsp">Home</a></li>
                    <li><a href="beranda1.jsp?hal=about">About</a></li>
                </ul>
            </div>
            ...
            <div class="menu">
                <li class="item" id="master">
                    ...
                    <div class="smenu">
                        <a href="beranda1.jsp?hal=tampil_siswa">Data Siswa</a>
                        <a href="beranda1.jsp?hal=tampil_kategori2">Data Kategori</a>
                        <a href="beranda1.jsp?hal=tampil_akun2">Data Akun</a>
                ...
                <li class="item" id="transaksi" style="list-style-type: none;">
                    ...
                    <div class="smenu">
                        <a href="beranda1.jsp?hal=pembayaran">Pembayaran Siswa</a>
                ...
                <li class="item" id="laporan" style="list-style-type: none;">
                    ...
                    <div class="smenu">
                        <a href="beranda1.jsp?hal=laporan_harian">Penerimaan Kas</a>
                        <%-- 
                        <a href="beranda1.jsp?hal=laporan_bulanan">Penerimaan Kas Bulanan</a>
                ...
                <li class="item" id="pengaturan" style="list-style-type: none;">
                    ...
                    <div class="smenu">
                        <a href="beranda1.jsp?hal=edit_profil&id_user=<%=session.getAttribute("id_user") %>">Edit Profil</a>
                        <a href="beranda1.jsp?hal=backup">Backup & Restore</a>
                    </div>
                </li>
                <li class="item" id="laporan" style="list-style-type: none;">
                        ...
                        <tr>
                            <td align="top">
                                 <c:choose>
                                    ...
                                    <c:when test="${param.hal=='tampil_kategori2'}">
                                        <%@include file="tampil_kategori2.jsp" %>
                                    </c:when>
                                    ...
                                    <c:when test="${param.hal=='tampil_akun2'}">
                                        <%@include file="tampil_akun2.jsp" %>
                                    </c:when>
