...
<html>
    ...
    <table width="90%" border="0" align="center">
        <tr>
            <td><a href="beranda.jsp?hal=input_kategori" id="biru" ><i class="fas fa-plus-circle"></i> TAMBAH DATA</a></td>
    ...
    <table width="90%" border="1" align="center" class="display">
        ...
        <tbody  id="dataTable">
            <tr id="klik">          
                ...
                <td align="center"><a href="beranda.jsp?hal=edit_kategori&id_kategori=<% out.print(id_kategori); %>" id="hijau">EDIT</a>
                    <a href="kategoriServlet?aksi=Delete&id_kategori=<% out.print(id_kategori);%>" id="merah">HAPUS</a>
                </td>      
